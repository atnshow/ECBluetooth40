 ...
 */
@SuppressLint("NewApi")
public abstract class BaseBluetoothScanActivity extends BaseBluetoothIsOpenActivity {
    ...
    */
    ...
    private class LeDeviceListAdapter extends BaseAdapter {
        ...
        public LeDeviceListAdapter() {
            ...
            mInflator = BaseDeviceScanActivity.this.getLayoutInflater();
        }
    ...
    protected BluetoothAdapter.LeScanCallback mLeScanCallback = new BluetoothAdapter.LeScanCallback() {
        ...
        public void onLeScan(final BluetoothDevice bluetoothDevice, final int rssi, final byte[] scanRecord) {
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    onLeScanCallback4OnLeScanCallback(bluetoothDevice, rssi, scanRecord);
...
//    protected BluetoothAdapter.LeScanCallback mLeScanCallback = null;
     ...
     *
     */
    protected abstract void onLeScanCallback4OnLeScanCallback(BluetoothDevice bluetoothDevice, int rssi, byte[] scanRecord);
